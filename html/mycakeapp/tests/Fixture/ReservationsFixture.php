...
class ReservationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'seat_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'basic_rate_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'basic_rate_id' => 1,
                'is_deleted' => 1,
                'created' => '2020-11-02 10:57:23',
                'modified' => '2020-11-02 10:57:23',
            ],
        ];
        parent::init();
    }
