...
class SchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'end_datetime' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'movie_id' => 1,
                'start_datetime' => '2020-11-02 10:59:30',
                'end_datetime' => '2020-11-02 10:59:30',
                'is_deleted' => 1,
                'created' => '2020-11-02 10:59:30',
                'modified' => '2020-11-02 10:59:30',
            ],
        ];
        parent::init();
    }
