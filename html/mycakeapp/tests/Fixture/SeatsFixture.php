...
class SeatsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'seat_number' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'seat_number' => 'Lor',
                'is_deleted' => 1,
                'created' => '2020-12-03 10:37:38',
                'modified' => '2020-12-03 10:37:38',
            ],
        ];
        parent::init();
    }
